...
Survive 7am to 7pm. Collect stickers for your big dumb mug. Try not to lose your mind.

*(Spoiler: You will lose your mind.)*
...
4. What did you expect, a 47-step CI/CD pipeline?

**Works on:** Chrome, Firefox, Safari, Edge, your phone, your tablet, probably your smart fridge
...
- 👨‍⚕️ **The Resident** - Fresh out of med school. Thinks a neonate is a type of rock. Will wake your baby to "assess." Drain your sanity by asking if the baby is "NPO" while literally holding the feeding tube.

- 😷 **The Surgeon** - Arrogant. Fast. Thinks nurses are just tall robots that dispense medications. Will give you orders in the hallway and expect you to have already done them yesterday. Maximum sanity drain. Avoid at all costs.
...
Your 6 isolettes contain tiny potatoes who will need:
...
- Pure vanilla JavaScript because we're old school
- HTML5 Canvas with pixel art sprites
- Tailwind CSS via CDN because npm is for people with time
- Web Audio API for the beeps (all 6 of them)
- Touch support so you can play on your phone during your 30-second lunch break

**No frameworks. No build process. No npm. No yarn. No webpack. No vite.**

Just HTML, CSS, and the raw determination that got you through nursing school.

## Credits

**Created by:** Someone who clearly has Feelings™ about healthcare

**Inspired by:** Every nurse who's ever been given a pen that says "You're Essential!" instead of a raise

**Dedicated to:** The 7p-7a crew, the 7a-7p warriors, and everyone in between who keeps tiny humans alive while running on cold coffee and spite

**Special thanks to:**
- Coffee
- The bathroom
- That one good chair
- Nurses everywhere who do this for real, every day, without the pixel art

## License

MIT License, which means you can do whatever you want with this.

Unlike your hospital's "No Sitting During Your 12-Hour Shift" policy.
...
A: Every shift is based on a true story.

**Q: Why can't I punch the surgeon?**  
A: This is a *family-friendly* representation of healthcare. Also, HR.

**Q: Can I add more stickers?**  
A: Fork it. Add 400 stickers. Add a sticker that says "I Survived My Manager's Motivational Email." Go wild.

**Q: Is the sanity drain realistic?**  
...
*"It's not about the money. It's about sending a message. That message is: I need a lunch break."*

**Now get in there and clock in. Those babies aren't going to feed themselves.**

*(They literally can't. That's why you're here.)*
